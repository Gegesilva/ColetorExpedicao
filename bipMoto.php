...
<body>
	<section class="content">
		<div class="box_form">
			<h1>Motorista<button class="btn-voltar"><a class="btn-voltar" href="http://localhost:8090/phpprod/tecnolta/coletorexpedicao/motorista.php">VOLTAR</a> </button></h1>
