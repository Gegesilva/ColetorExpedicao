  ...
  header('Content-type: text/html; charset=utf-8');
   ...
   $senha = $_SESSION["password"];
     ...
     if($usuario != NULL){
       ...
       echo "<script>location.href='http://localhost:8090/phpprod/positiva/coletores/login.php'</script>";
       
     } 


  $conferencia = ($permGrafOs == '1') ? '<form class="form-btn" action="http://localhost:8090/phpprod/positiva/coletores/coletorconferencia/inicio.php">
                                          <input type="submit" id="deletar"  class="btn btn-outline-secondary" value="Conferência"></input>
                                         </form> ' : '';
  $retornoExp = ($permVendas == '1') ? ' <form class="form-btn" action="http://localhost:8090/phpprod/positiva/coletores/coletorretornoexp/inicio.php">
                                          <input type="submit" id="inserir" class="btn btn-outline-secondary" value="Retorno Exp"></input>
                                         </form>  ' : ''; 
  $retorno = ($permGrafReq == '1') ? '   <form class="form-btn" action="http://localhost:8090/phpprod/positiva/coletores/coletorretorno/inicio.php">
                                          <input type="submit" id="inserir" class="btn btn-outline-secondary" value="Retorno"></input>
                                         </form>' : '';
  $triagem = ($permUsu == '1') ? '       <form class="form-btn" action="http://localhost:8090/phpprod/positiva/coletores/coletortriagem/bip1.php">
                                          <input type="submit" id="inserir" class="btn btn-outline-secondary" value="Triagem"></input>
                                         </form>' : '';
  $expedicao = ($permChat == '1') ? '    <form class="form-btn" action="http://localhost:8090/phpprod/positiva/coletores/coletorexpedicao/inicio.php">
...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <div class="card" style="background-color: white; width: auto; margin-left: 2%; margin-right: 2%; margin-top: 2%; border-radius: 30px;">
     <form action="http://localhost:8090/phpprod/positiva/coletores/login.php"><button class="btn-voltar">SAIR</button></form>
